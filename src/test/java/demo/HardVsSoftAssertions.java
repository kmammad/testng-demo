...
//        Assert.assertTrue(driver.getPageSource().contains("Welcome"));
        ...
        softAssert.assertEquals(driver.getTitle(), "Web Orders");
        softAssert.assertEquals(driver.getCurrentUrl(), "http://secure.smartbearsoftware.com/samples/testcomplete12/weborders/");
